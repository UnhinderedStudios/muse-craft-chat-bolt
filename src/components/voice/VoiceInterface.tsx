  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center p-8">
      ...
      <div className="flex-1 flex items-center justify-center w-full max-w-4xl relative">
        ...
        {/* Controls Row - aligned with bottom of chat display */}
        <div className="absolute bottom-24 left-1/2 transform -translate-x-1/2 flex items-center justify-center space-x-6">
          {/* Chat Log Toggle */}
          <Button
            variant="ghost"
            size="icon"
