          ...
          <div className="grid grid-cols-12 gap-4 h-auto">
            ...
            <div className="col-span-5 space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-[#2d2d2d] rounded-lg p-4 hover:shadow-[0_0_5px_rgba(246,49,140,0.25)] focus-within:shadow-[0_0_5px_rgba(255,255,255,0.5)] focus-within:hover:shadow-[0_0_5px_rgba(255,255,255,0.5)] transition-shadow duration-200">
                  <Input
                    value={details.title || ""}
            ...
            <div className="col-span-7 space-y-2 flex flex-col">
              ...
              <div className="bg-[#2d2d2d] rounded-lg p-4 flex-1 hover:shadow-[0_0_5px_rgba(246,49,140,0.25)] focus-within:shadow-[0_0_5px_rgba(255,255,255,0.5)] focus-within:hover:shadow-[0_0_5px_rgba(255,255,255,0.5)] transition-shadow duration-200">
                <Textarea
